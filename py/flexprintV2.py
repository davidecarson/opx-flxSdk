...
class FlexSwitchShow( object):
    ...
    def printOspfv2IntfStates(self, addHeader=True, brief=None):
        ...
        if addHeader:
            ...
            header.append('NumOfRouterLSA')
            header.append('NumOfNetworkLSA')
            header.append('NumOfSummary3LSA')
            header.append('NumOfSummary4LSA')
            header.append('NumOfASExternalLSA')
            header.append('NumOfLSA')
            header.append('NumOfNbrs')
            header.append('NumOfRoutes')
            header.append('Mtu')
            header.append('Cost')
            header.append('NumOfStateChange')
            header.append('TimeOfStateChange')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['NumOfRouterLSA'])
            values.append('%s' % o['NumOfNetworkLSA'])
            values.append('%s' % o['NumOfSummary3LSA'])
            values.append('%s' % o['NumOfSummary4LSA'])
            values.append('%s' % o['NumOfASExternalLSA'])
            values.append('%s' % o['NumOfLSA'])
            values.append('%s' % o['NumOfNbrs'])
            values.append('%s' % o['NumOfRoutes'])
            values.append('%s' % o['Mtu'])
            values.append('%s' % o['Cost'])
            values.append('%s' % o['NumOfStateChange'])
            values.append('%s' % o['TimeOfStateChange'])
            rows.append(values)
    ...
    def printPolicyExtendedCommunitySetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ExtendedCommunityList')
            header.append('PolicyConditionList')

        objs = self.swtch.getAllPolicyExtendedCommunitySetStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['ExtendedCommunityList'])
            values.append('%s' % o['PolicyConditionList'])
            rows.append(values)
        self.tblPrintObject('PolicyExtendedCommunitySetState', header, rows)


    def printPolicyExtendedCommunitySetState(self, Name, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ExtendedCommunityList')
        ...
        rawobj = self.swtch.getPolicyExtendedCommunitySetState(
                                                               Name)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedPolicyExtendedCommunitySetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ExtendedCommunityList')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['ExtendedCommunityList'])
            values.append('%s' % o['PolicyConditionList'])
            r = self.swtch.getPolicyExtendedCommunitySet(o['Name'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
            rows.append(values)
        self.tblPrintObject('PolicyExtendedCommunitySetState', header, rows)
    ...
    def printDHCPv6RelayGlobals(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('HopCountLimit')
            header.append('Enable')

        objs = self.swtch.getAllDHCPv6RelayGlobals()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vrf'])
            values.append('%s' % o['HopCountLimit'])
            values.append('%s' % o['Enable'])
            rows.append(values)
        self.tblPrintObject('DHCPv6RelayGlobal', header, rows)
    ...
    def printAclIpv4Filters(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('FilterName')
            ...
            header.append('DstIntf')
            header.append('SrcIntf')
            header.append('SourceMask')
            header.append('L4MaxPort')
            header.append('SourceIp')
            header.append('L4PortMatch')

        objs = self.swtch.getAllAclIpv4Filters()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['FilterName'])
    ...
    def printVrrpGlobalStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('Status')
            header.append('V4Intfs')
            header.append('V6Intfs')
            header.append('TotalRxFrames')
            header.append('TotalTxFrames')

        objs = self.swtch.getAllVrrpGlobalStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vrf'])
            values.append('%s' % o['Status'])
            values.append('%s' % o['V4Intfs'])
            values.append('%s' % o['V6Intfs'])
            values.append('%s' % o['TotalRxFrames'])
            values.append('%s' % o['TotalTxFrames'])
            rows.append(values)
        self.tblPrintObject('VrrpGlobalState', header, rows)


    def printVrrpGlobalState(self, Vrf, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('Status')
        ...
        rawobj = self.swtch.getVrrpGlobalState(
                                               Vrf)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedVrrpGlobalStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('Status')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['TotalRxFrames'])
            values.append('%s' % o['TotalTxFrames'])
            r = self.swtch.getVrrpGlobal(o['Vrf'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Enable'])
            rows.append(values)
    ...
    def printOspfv2RouteStates(self, addHeader=True, brief=None):
        ...
        if addHeader:
            ...
            header.append('Type2Cost')
            header.append('NumOfPaths')
            header.append('LSOriginLSType')
            header.append('LSOriginLSId')
            header.append('LSOriginAdvRouter')
            header.append('NextHops')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['Type2Cost'])
            values.append('%s' % o['NumOfPaths'])
            values.append('%s' % o['LSOriginLSType'])
            values.append('%s' % o['LSOriginLSId'])
            values.append('%s' % o['LSOriginAdvRouter'])
            values.append('%s' % o['NextHops'])
            rows.append(values)
    ...
    def printVxlanInstanceStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vni')
            header.append('VlanId')
        ...
        objs = self.swtch.getAllVxlanInstanceStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vni'])
            ...
            values.append('%s' % o['OperState'])
            rows.append(values)
        self.tblPrintObject('VxlanInstanceState', header, rows)


    def printVxlanInstanceState(self, Vni, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vni')
            header.append('VlanId')
        ...
        rawobj = self.swtch.getVxlanInstanceState(
                                                  Vni)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedVxlanInstanceStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vni')
            header.append('VlanId')
            header.append('OperState')
            header.append('UntaggedVlanId')
            header.append('AdminState')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['VlanId'])
            values.append('%s' % o['OperState'])
            r = self.swtch.getVxlanInstance(o['Vni'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['UntaggedVlanId'])
                values.append('%s' % o['AdminState'])
            rows.append(values)
        self.tblPrintObject('VxlanInstanceState', header, rows)
    ...
    def printRedistributionPolicys(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
        ...
        objs = self.swtch.getAllRedistributionPolicys()
        for obj in objs:
            o = obj['Object']
            values = []
            ...
            rows.append(values)
        self.tblPrintObject('RedistributionPolicy', header, rows)
    ...
    def printVxlanVtepInstanceStates(self, addHeader=True, brief=None):
        ...
        objs = self.swtch.getAllVxlanVtepInstanceStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Intf'])
            ...
            values.append('%s' % o['IfIndex'])
            values.append('%s' % o['VlanId'])
            values.append('%s' % o['PerDstIpState'])
            values.append('%s' % o['TOS'])
            values.append('%s' % o['Mtu'])
            values.append('%s' % o['InnerVlanHandlingMode'])
            values.append('%s' % o['TTL'])
            ...
            values.append('%s' % o['SrcIp'])
            rows.append(values)
        self.tblPrintObject('VxlanVtepInstanceState', header, rows)


    def printVxlanVtepInstanceState(self, Intf,Vni, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Intf')
            header.append('Vni')
        ...
        rawobj = self.swtch.getVxlanVtepInstanceState(
                                                      Intf,
                                                      Vni)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printCombinedVxlanVtepInstanceStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Intf')
            header.append('Vni')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['DstUDP'])
            values.append('%s' % o['SrcIp'])
            r = self.swtch.getVxlanVtepInstance(o['Intf'], o['Vni'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['DstIp'])
                values.append('%s' % o['AdminState'])
    ...
    def printDHCPRelayIntfServerState(self, IntfRef,ServerIp, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('ServerIp')
    ...
    def printAclMacFilters(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('FilterName')
        ...
        objs = self.swtch.getAllAclMacFilters()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['FilterName'])
            ...
            rows.append(values)
        self.tblPrintObject('AclMacFilter', header, rows)
    ...
    def printPolicyCommunitySetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('CommunityList')
            header.append('PolicyConditionList')

        objs = self.swtch.getAllPolicyCommunitySetStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['CommunityList'])
            values.append('%s' % o['PolicyConditionList'])
            rows.append(values)
        self.tblPrintObject('PolicyCommunitySetState', header, rows)


    def printPolicyCommunitySetState(self, Name, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('CommunityList')
        ...
        rawobj = self.swtch.getPolicyCommunitySetState(
                                                       Name)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedPolicyCommunitySetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('CommunityList')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['CommunityList'])
            values.append('%s' % o['PolicyConditionList'])
            r = self.swtch.getPolicyCommunitySet(o['Name'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
            rows.append(values)
        self.tblPrintObject('PolicyCommunitySetState', header, rows)
    ...
    def printAclState(self, AclName, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('AclName')
            header.append('Priority')
    ...
    def printPolicyASPathSetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ASPathList')
            header.append('PolicyConditionList')

        objs = self.swtch.getAllPolicyASPathSetStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['ASPathList'])
            values.append('%s' % o['PolicyConditionList'])
            rows.append(values)
        self.tblPrintObject('PolicyASPathSetState', header, rows)


    def printPolicyASPathSetState(self, Name, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ASPathList')
        ...
        rawobj = self.swtch.getPolicyASPathSetState(
                                                    Name)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedPolicyASPathSetStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ASPathList')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['ASPathList'])
            values.append('%s' % o['PolicyConditionList'])
            r = self.swtch.getPolicyASPathSet(o['Name'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
            rows.append(values)
        self.tblPrintObject('PolicyASPathSetState', header, rows)
    ...
    def printVrrpV4Intfs(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        objs = self.swtch.getAllVrrpV4Intfs()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            rows.append(values)
        self.tblPrintObject('VrrpV4Intf', header, rows)


    def printAclIpv6Filters(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('FilterName')
            header.append('SourceIpv6')
            header.append('L4MinPort')
            header.append('L4DstPort')
            header.append('DestIpv6')
            header.append('Proto')
            header.append('L4SrcPort')
            header.append('DstIntf')
            header.append('SrcIntf')
            header.append('SourceMaskv6')
            header.append('DestMaskv6')
            header.append('L4MaxPort')
            header.append('L4PortMatch')

        objs = self.swtch.getAllAclIpv6Filters()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['FilterName'])
            values.append('%s' % o['SourceIpv6'])
            values.append('%s' % o['L4MinPort'])
            values.append('%s' % o['L4DstPort'])
            values.append('%s' % o['DestIpv6'])
            values.append('%s' % o['Proto'])
            values.append('%s' % o['L4SrcPort'])
            values.append('%s' % o['DstIntf'])
            values.append('%s' % o['SrcIntf'])
            values.append('%s' % o['SourceMaskv6'])
            values.append('%s' % o['DestMaskv6'])
            values.append('%s' % o['L4MaxPort'])
            values.append('%s' % o['L4PortMatch'])
            rows.append(values)
        self.tblPrintObject('AclIpv6Filter', header, rows)
    ...
    def printPolicyCommunitySets(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('CommunityList')

        objs = self.swtch.getAllPolicyCommunitySets()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['CommunityList'])
            rows.append(values)
        self.tblPrintObject('PolicyCommunitySet', header, rows)


    def printPolicyExtendedCommunitySets(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ExtendedCommunityList')

        objs = self.swtch.getAllPolicyExtendedCommunitySets()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['ExtendedCommunityList'])
            rows.append(values)
        self.tblPrintObject('PolicyExtendedCommunitySet', header, rows)
    ...
    def printVrrpV6IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
            ...
            header.append('VirtualAddress')
            header.append('VirtualMACAddress')
            header.append('DownTimer')
            header.append('AdvertisementInterval')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['AdvertisementInterval'])
            rows.append(values)
        self.tblPrintObject('VrrpV6IntfState', header, rows)


    def printVrrpV6IntfState(self, IntfRef,VRID, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        rawobj = self.swtch.getVrrpV6IntfState(
                                               IntfRef,
                                               VRID)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printCombinedVrrpV6IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['DownTimer'])
            values.append('%s' % o['AdvertisementInterval'])
            r = self.swtch.getVrrpV6Intf(o['IntfRef'], o['VRID'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Address'])
                values.append('%s' % o['PreemptMode'])
    ...
    def printVrrpGlobals(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('Enable')

        objs = self.swtch.getAllVrrpGlobals()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vrf'])
            values.append('%s' % o['Enable'])
            rows.append(values)
        self.tblPrintObject('VrrpGlobal', header, rows)


    def printPolicyASPathSets(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Name')
            header.append('ASPathList')

        objs = self.swtch.getAllPolicyASPathSets()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Name'])
            values.append('%s' % o['ASPathList'])
            rows.append(values)
        self.tblPrintObject('PolicyASPathSet', header, rows)
    ...
    def printDHCPRelayIntfState(self, IntfRef, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('TotalDrops')
    ...
    def printCombinedDHCPRelayIntfStates(self, addHeader=True, brief=None):
        ...
        for obj in objs:
            ...
            values.append('%s' % o['TotalDhcpServerRx'])
            values.append('%s' % o['TotalDhcpServerTx'])
            r = self.swtch.getDHCPRelayIntf(o['IntfRef'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Enable'])
                values.append('%s' % o['ServerIp'])
    ...
    def printVrrpV6Intfs(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        objs = self.swtch.getAllVrrpV6Intfs()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            values.append('%s' % o['AcceptMode'])
            rows.append(values)
        self.tblPrintObject('VrrpV6Intf', header, rows)
    ...
    def printDHCPv6RelayClientStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('MacAddr')
            header.append('ServerIp')
            ...
            header.append('ClientSolicit')
            header.append('ClientRequest')
            header.append('ClientConfirm')
            header.append('ClientRenew')
            header.append('ClientRebind')
            header.append('ClientRelease')
            header.append('ClientDecline')
            header.append('ClientInfoRequest')
            header.append('ClientRequests')
            header.append('ClientResponses')
            header.append('ServerAdvertise')
            header.append('ServerReply')
            header.append('ServerReconfigure')
            header.append('ServerRequests')
            header.append('ServerResponses')

        objs = self.swtch.getAllDHCPv6RelayClientStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['MacAddr'])
            ...
            values.append('%s' % o['ClientSolicit'])
            values.append('%s' % o['ClientRequest'])
            values.append('%s' % o['ClientConfirm'])
            values.append('%s' % o['ClientRenew'])
            values.append('%s' % o['ClientRebind'])
            values.append('%s' % o['ClientRelease'])
            values.append('%s' % o['ClientDecline'])
            values.append('%s' % o['ClientInfoRequest'])
            values.append('%s' % o['ClientRequests'])
            values.append('%s' % o['ClientResponses'])
            values.append('%s' % o['ServerAdvertise'])
            values.append('%s' % o['ServerReply'])
            values.append('%s' % o['ServerReconfigure'])
            values.append('%s' % o['ServerRequests'])
            values.append('%s' % o['ServerResponses'])
            rows.append(values)
        self.tblPrintObject('DHCPv6RelayClientState', header, rows)


    def printDHCPv6RelayClientState(self, MacAddr, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('MacAddr')
            header.append('ServerIp')
        ...
        rawobj = self.swtch.getDHCPv6RelayClientState(
                                                      MacAddr)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printDHCPv6RelayIntfServerStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('ServerIp')
        ...
        objs = self.swtch.getAllDHCPv6RelayIntfServerStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            values.append('%s' % o['Responses'])
            rows.append(values)
        self.tblPrintObject('DHCPv6RelayIntfServerState', header, rows)


    def printDHCPv6RelayIntfServerState(self, IntfRef,ServerIp, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('ServerIp')
        ...
        rawobj = self.swtch.getDHCPv6RelayIntfServerState(
                                                          IntfRef,
                                                          ServerIp)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printDHCPv6RelayIntfs(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Enable')
            header.append('ServerIp')
            header.append('UpstreamIntfs')

        objs = self.swtch.getAllDHCPv6RelayIntfs()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            values.append('%s' % o['Enable'])
            values.append('%s' % o['ServerIp'])
            values.append('%s' % o['UpstreamIntfs'])
            rows.append(values)
        self.tblPrintObject('DHCPv6RelayIntf', header, rows)
    ...
    def printSubIPv4IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
            header.append('IfIndex')
            header.append('IfName')
            header.append('ParentIfIndex')
            header.append('IpAddr')
            header.append('MacAddr')
            header.append('OperState')

        objs = self.swtch.getAllSubIPv4IntfStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            values.append('%s' % o['IfIndex'])
            values.append('%s' % o['IfName'])
            values.append('%s' % o['ParentIfIndex'])
            values.append('%s' % o['IpAddr'])
            values.append('%s' % o['MacAddr'])
            values.append('%s' % o['OperState'])
            rows.append(values)
        self.tblPrintObject('SubIPv4IntfState', header, rows)


    def printSubIPv4IntfState(self, IntfRef,Type, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
        ...
        rawobj = self.swtch.getSubIPv4IntfState(
                                                IntfRef,
                                                Type)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printCombinedSubIPv4IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['MacAddr'])
            values.append('%s' % o['OperState'])
            r = self.swtch.getSubIPv4Intf(o['Type'], o['IntfRef'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Enable'])
            rows.append(values)
    ...
    def printCombinedPolicyConditionStates(self, addHeader=True, brief=None):
        ...
        if addHeader:
            ...
            header.append('Protocol')
            header.append('MED')
            header.append('ExtendedCommunitySet')
            header.append('LocalPref')
            header.append('ASPath')
            header.append('Community')
            header.append('IpPrefix')
            header.append('ExtendedCommunityType')
            header.append('ASPathSet')
            header.append('PrefixSet')
            header.append('MaskLengthRange')
            header.append('CommunitySet')
            header.append('ExtendedCommunityValue')
        ...
        for obj in objs:
            ...
            if r.status_code in self.httpSuccessCodes:
                ...
                values.append('%s' % o['Protocol'])
                values.append('%s' % o['MED'])
                values.append('%s' % o['ExtendedCommunitySet'])
                values.append('%s' % o['LocalPref'])
                values.append('%s' % o['ASPath'])
                values.append('%s' % o['Community'])
                values.append('%s' % o['IpPrefix'])
                values.append('%s' % o['ExtendedCommunityType'])
                values.append('%s' % o['ASPathSet'])
                values.append('%s' % o['PrefixSet'])
                values.append('%s' % o['MaskLengthRange'])
                values.append('%s' % o['CommunitySet'])
                values.append('%s' % o['ExtendedCommunityValue'])
            rows.append(values)
        self.tblPrintObject('PolicyConditionState', header, rows)
    ...
    def printVxlanGlobals(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('AdminState')

        objs = self.swtch.getAllVxlanGlobals()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vrf'])
            values.append('%s' % o['AdminState'])
            rows.append(values)
        self.tblPrintObject('VxlanGlobal', header, rows)
    ...
    def printVxlanGlobalStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('RxInvalidVtepCnt')
            header.append('NumVteps')
            header.append('OperState')

        objs = self.swtch.getAllVxlanGlobalStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['Vrf'])
            values.append('%s' % o['RxInvalidVtepCnt'])
            values.append('%s' % o['NumVteps'])
            values.append('%s' % o['OperState'])
            rows.append(values)
        self.tblPrintObject('VxlanGlobalState', header, rows)


    def printVxlanGlobalState(self, Vrf, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('RxInvalidVtepCnt')
        ...
        rawobj = self.swtch.getVxlanGlobalState(
                                                Vrf)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedVxlanGlobalStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('Vrf')
            header.append('RxInvalidVtepCnt')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['NumVteps'])
            values.append('%s' % o['OperState'])
            r = self.swtch.getVxlanGlobal(o['Vrf'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['AdminState'])
            rows.append(values)
    ...
    def printDHCPRelayClientStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('MacAddr')
            header.append('ServerIp')
        ...
        objs = self.swtch.getAllDHCPRelayClientStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['MacAddr'])
            ...
            values.append('%s' % o['ServerResponses'])
            rows.append(values)
        self.tblPrintObject('DHCPRelayClientState', header, rows)


    def printDHCPRelayClientState(self, MacAddr, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('MacAddr')
            header.append('ServerIp')
        ...
        rawobj = self.swtch.getDHCPRelayClientState(
                                                    MacAddr)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printVrrpV4IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['AdvertisementInterval'])
            rows.append(values)
        self.tblPrintObject('VrrpV4IntfState', header, rows)


    def printVrrpV4IntfState(self, IntfRef,VRID, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        rawobj = self.swtch.getVrrpV4IntfState(
                                               IntfRef,
                                               VRID)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printCombinedVrrpV4IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('VRID')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['DownTimer'])
            values.append('%s' % o['AdvertisementInterval'])
            r = self.swtch.getVrrpV4Intf(o['IntfRef'], o['VRID'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Address'])
                values.append('%s' % o['PreemptMode'])
    ...
    def printDHCPv6RelayIntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('TotalDrops')
        ...
        objs = self.swtch.getAllDHCPv6RelayIntfStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            values.append('%s' % o['TotalDhcpServerTx'])
            rows.append(values)
        self.tblPrintObject('DHCPv6RelayIntfState', header, rows)


    def printDHCPv6RelayIntfState(self, IntfRef, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('TotalDrops')
        ...
        rawobj = self.swtch.getDHCPv6RelayIntfState(
                                                    IntfRef)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
            o = obj['Object']
    ...
    def printCombinedDHCPv6RelayIntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('TotalDrops')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['TotalDhcpServerRx'])
            values.append('%s' % o['TotalDhcpServerTx'])
            r = self.swtch.getDHCPv6RelayIntf(o['IntfRef'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Enable'])
                values.append('%s' % o['ServerIp'])
    ...
    def printSubIPv6IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
        ...
        objs = self.swtch.getAllSubIPv6IntfStates()
        for obj in objs:
            o = obj['Object']
            values = []
            values.append('%s' % o['IntfRef'])
            ...
            values.append('%s' % o['OperState'])
            rows.append(values)
        self.tblPrintObject('SubIPv6IntfState', header, rows)


    def printSubIPv6IntfState(self, IntfRef,Type, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
        ...
        rawobj = self.swtch.getSubIPv6IntfState(
                                                IntfRef,
                                                Type)
        if rawobj.status_code in self.httpSuccessCodes:
            obj = rawobj.json()
    ...
    def printCombinedSubIPv6IntfStates(self, addHeader=True, brief=None):
        header = []; rows = []
        if addHeader:
            header.append('IntfRef')
            header.append('Type')
        ...
        for obj in objs:
            ...
            values.append('%s' % o['MacAddr'])
            values.append('%s' % o['OperState'])
            r = self.swtch.getSubIPv6Intf(o['IntfRef'], o['Type'])
            if r.status_code in self.httpSuccessCodes:
                o = r.json()['Object']
                values.append('%s' % o['Enable'])
                values.append('%s' % o['LinkIp'])
